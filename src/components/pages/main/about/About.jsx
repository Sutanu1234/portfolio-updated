          ...
          <div className="p-4 border-2 rounded-3xl border-gray-600">
            ...
            <div className="flex gap-4 flex-col md:flex-row">
              <p className="text-md text-gray-600">
                ...
                MERN stack development, and UI/UX design. Solved 400+ problems
                on LeetCode, built scalable applications, and designed intuitive
            ...
            {cards.map((card, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className={`text-sm ${textColor}`}>{card.value}</p>
                </div>
              );
            })}
          </div>
